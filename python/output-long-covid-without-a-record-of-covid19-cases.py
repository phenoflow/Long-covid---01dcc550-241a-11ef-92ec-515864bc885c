...
def checkRow(row):
    ...
    row['long-covid-without-a-record-of-covid19-identified'] = 'CASE';
    return row;

cases = [["long-covid---tadds-identified","long-covid-assessment---tadds-identified"]];
...
with open(sys.argv[1], 'r') as file_in, open('long-covid-cases.csv', 'w', newline='') as file_out:
    ...
    csv_writer = csv.DictWriter(file_out, list(set(csv_reader.fieldnames)-set(all_cases)-set(all_exclude)) + ['long-covid-without-a-record-of-covid19-identified'])
    ...
    for row in csv_reader:
        ...
        new_row['long-covid-without-a-record-of-covid19-identified'] = 'UNK';
